...
class ContactSupplierPopup extends StatefulWidget {
  const ContactSupplierPopup({super.key, required this.listing, this.onCancel});
  ...
  Future<void> _submitContact() async {
    ...
    try {
      ...
      final response = await NetworkHelper.sendRequest(
        ...
        data: {'mobile': mobile, 'service_id': widget.listing.id},
      );
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                widget.listing != null &&
                                        widget.listing!.reviews.isNotEmpty
                                    ? widget.listing!.reviews.first.rating ??
                                          "0.0"
                                    : "0.0",
                                style: context.labelSmall.copyWith(
                                  color: lightGreyTextColor,
