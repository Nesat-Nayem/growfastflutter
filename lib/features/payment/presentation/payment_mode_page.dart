...
class _PaymentModePageState extends State<PaymentModePage> {
  String selectedPaymentMethod = 'pay_after_work';
  ...
  void _startPayment(double totalAmount) {
    ...
    _processPayAfterWork();
  }

  Future<void> _processPayAfterWork() async {
    setState(() {
    ...
    try {
      ...
      if (response.data['status'] == 'success') {
        // Log Meta Purchase event for Pay After Work
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Booking confirmed! Pay after work.'),
            ),
          );
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          horizontalMargin16,
                          Expanded(
                            child: Text("Pay After Work", style: context.labelLarge),
                          ),
                          Container(
                            width: 20,
                            height: 20,
